...
if(!isset($_SESSION['admin_mobile'])){
    ...
    $admin_mobile_i=$row_admin['admin_mobile'];
    $admin_email_i=$row_admin['admin_email'];
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="container-fluid" align="center">
                    <img class="img-profile rounded-circle" src="admin_images/<?php echo $admin_image; ?>" width="10%">
                </div>
                <br>
                <div class="container-fluid" align="center">
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Name: </td>
                          <td><?php echo $admin_name_i; ?></td>
                          
                        </tr>
                        <tr>
                          
                          <td>Mobile: </td>
                          <td><?php echo $admin_mobile_i; ?></td>
                          
                        </tr>
                        <tr>
                          
                          <td>Email:</td>
                          <td><?php echo $admin_email_i; ?></td>
                        </tr>
                        <tr>
                          <td>Birthday:</td>
                          <td><?php echo ''; ?></td>
