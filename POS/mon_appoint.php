...
<?php
        ...
        $get_appo="select * from appointment_dump_u where appoint_status='Pending' AND appoint_outlet_id='$pos_id'";
    ...
    <a href="mon_appoint_det.php?appoint_id=<?php echo $appoint_id; ?>&appo_id=<?php echo $appo_id; ?>">
