...
if(isset($_GET['appoint_id'])){
    ...
    $upd_app="UPDATE appointment_dump SET appoint_status='P_Cancel' where appoint_id='$appoint_id'";
    $run_upd_app=mysqli_query($con, $upd_app);
    
    $upd_app_u="UPDATE appointment_dump_u SET appoint_status='P_Cancel' where appo_id='$appo_id'";
