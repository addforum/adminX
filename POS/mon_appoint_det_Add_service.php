...
<div class="container-fluid">
  ...
  <div class="row" align="center" class="container">
    <h7 for="sel_serv"><font size="4" color="blue">Select Services:</font></h7>
    
    
    
    
    <div id="a">
    <form method="POST" action="mon_appoint_det_Add_service_execute.php.php">
    <table class="table">
        <input type="hidden" name="appoint_id" value="<?php echo $appoint_id; ?>">
        <input type="hidden" name="appo_id" value="<?php echo $appo_id; ?>">
        <tr>
                        <td>
                            <select multiple class="form-control" id="sel_serv" name="sel_serv[]" required="">
                        
                        
                        
                        <?php
                        $get_serv="select * from service_master where serv_status='ON'";
                        ...
                        ?>
                        <option value="<?php echo $serv_id ?>"><?php echo $serv_name ?></option>
                        <?php } ?>
                    ...
                    <tr align="center">
                        <td><input type="submit" class="btn btn-success" name="add_serv" value="ADD SERVICE"></td>
                    </tr>
    </table>
    </form>
    </div>
